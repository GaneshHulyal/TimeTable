...
public class DayDetail1 extends AppCompatActivity {
    ...
    private void initToolbar(){
        ...
        getSupportActionBar().setTitle(Disp_time1.sharedPreferences.getString(Disp_time1.SEL_DAY, null));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    private void setupListView(){

        Monday = getResources().getStringArray(R.array.Monday1);
        Tuesday = getResources().getStringArray(R.array.Tuesday1);
        Wednesday = getResources().getStringArray(R.array.Wednesday1);
        Thursday = getResources().getStringArray(R.array.Thursday1);
        Friday = getResources().getStringArray(R.array.Friday1);
        Saturday = getResources().getStringArray(R.array.Saturday1);
        ...
        String selected_day = Disp_time1.sharedPreferences.getString(Disp_time1.SEL_DAY, null);
