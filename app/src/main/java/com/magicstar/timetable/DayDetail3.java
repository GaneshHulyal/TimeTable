...
public class DayDetail3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day_detail3);
    ...
    private void setupUIViews(){
        listView = (ListView)findViewById(R.id.lvDayDetail3);
        toolbar = (android.support.v7.widget.Toolbar) findViewById(R.id.ToolbarDayDetail3);
    }

    private void initToolbar(){
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(Disp_time3.sharedPreferences.getString(Disp_time3.SEL_DAY, null));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }

    private void setupListView(){

        Monday = getResources().getStringArray(R.array.Monday3);
        Tuesday = getResources().getStringArray(R.array.Tuesday3);
        Wednesday = getResources().getStringArray(R.array.Wednesday3);
        Thursday = getResources().getStringArray(R.array.Thursday3);
        Friday = getResources().getStringArray(R.array.Friday3);
        Saturday = getResources().getStringArray(R.array.Saturday3);
        ...
        String selected_day = Disp_time3.sharedPreferences.getString(Disp_time3.SEL_DAY, null);
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(DayDetail3.this, PreferredDay, PreferredTime);
