...
public class DayDetail extends AppCompatActivity {
    ...
    private void initToolbar(){
        ...
        getSupportActionBar().setTitle(Disp_time.sharedPreferences.getString(Disp_time.SEL_DAY, null));
    ...
    private void setupListView(){
        ...
        String selected_day = Disp_time.sharedPreferences.getString(Disp_time.SEL_DAY, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case android.R.id.home : {
                startActivity(new Intent(DayDetail.this,MainActivity.class));
                this.finish();
                //onBackPressed();
            }
        }
